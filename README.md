...
Summed concentrations were log10-transformed to stabilize variance and reduce the influence of extreme values. Because pesticide concentrations differed in magnitude and units across matrices, log-transformed values were standardized within each matrix using z-scores.
